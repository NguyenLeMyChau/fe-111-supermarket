...
export const validatePromotionDetailData = (data) => {
    ...
    if (data.unit_id && !data.unit_id.trim()) {
        errors = 'ID đơn vị không được để trống';
    }
